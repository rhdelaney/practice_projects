...
int main(){ //int argc,char **argv
  ...
  sll *donkey = newSLL(displayInteger);
  insertSLL(donkey,0,newInteger(100));
  insertSLL(donkey,1,newInteger(101));
  insertSLL(donkey,2,newInteger(102));
  insertSLL(donkey,3,newInteger(103));

  //main statement
  //printf("But definitely not here right?\n");
  printf("\n \n");
  printf("\n-------------------------------------------------------------- \n \n");
  printf("SLL testing main.c! \n");
  ...
  for( int i = 0; i<5; i++){
    printf("Adding: %d",i);
    printf(" to the head \n");
    insertSLL(items,0,newInteger(i));               //insert 0-4 items at head
  }
  printf("\n");
  for( int i = 5; i < 10; i++) {
    insertSLL(items,sizeSLL(items),newInteger(i));      //insert at back
    printf("Adding: %d",i);
    printf(" to the tail \n");
  }
  printf("\n-------------------------------------------------------------- \n \n");
  ...
  insertSLL(items,1,newInteger(11));                   //insert at one after head
  insertSLL(items,4,newInteger(12));                   //insert at 4
  insertSLL(items,7,newInteger(13));                   //insert at 7
  insertSLL(items,8,newInteger(14));                   //insert at 8
...
//removing data at head and tail
 ...
 showItems(items);
 x = getInteger((integer *) getSLL(items,0));    //get the first item
 printf("The first item is %d.\n",x);
 
 printf("The value ");
 displayInteger(stdout,removeSLL(items,sizeSLL(items)-1));  //remove from tail
 printf(" was removed.\n");
 printf("\n");

 showItems(items);
 x = getInteger((integer *) getSLL(items,sizeSLL(items)-1)); //get the last item
 ...
 printf("The value ");
 displayInteger(stdout,removeSLL(items,3));  //remove from 3
 printf(" was removed.\n");
 printf("\n");

 showItems(items);
 x = getInteger((integer *) getSLL(items,3)); //get the last item
 printf("The 3rd index is now %d.\n",x);
 
 printf("The value ");
 displayInteger(stdout,removeSLL(items,5));  //remove from 3
 printf(" was removed.\n");
 printf("\n");

 showItems(items);
 x = getInteger((integer *) getSLL(items,5)); //get the last item
 ...
 printf("The value ");
 displayInteger(stdout,removeSLL(items,1));  //remove from 3
 printf(" was removed.\n");
 printf("\n");
 ...
 printf("The value ");
 displayInteger(stdout,removeSLL(items,1));          //remove from 1
 printf(" was removed.\n");
 
 printf("\n");

 showItems(items);
 x = getInteger((integer *) getSLL(items,1));    //get the 1st item
 printf("The 1st index is %d.\n",x);
  ...
  showItems(items);
  x = getInteger((integer *) getSLL(items,3));    //get the 3rd item
  printf("The 3rd index is %d.\n",x);
           
  printf("The value ");
  displayInteger(stdout,removeSLL(items,3));          //remove from 5
  printf(" was removed.\n");
  printf("\n");

  showItems(items);
  x = getInteger((integer *) getSLL(items,3));    //get the 5th item
